...
_FIELD_MAPPINGS = {
    ...
    "kis_index_minute_kospi": (
        ...
        FieldMapping("cntg_vol", "volume", "contracts_or_shares_unverified", CalculationMode.ACTIVITY),
        FieldMapping("acml_tr_pbmn", "cumulative_turnover", "provider_amount_unit_unverified", CalculationMode.ACTIVITY),
    ),
    "kis_program_summary_kospi": (
        FieldMapping("whol_smtn_ntby_tr_pbmn", "total_net_amount", "provider_amount_unit_unverified", CalculationMode.ACTUAL),
        FieldMapping("arbt_smtn_ntby_tr_pbmn", "arbitrage_net_amount", "provider_amount_unit_unverified", CalculationMode.ACTUAL),
        FieldMapping("nabt_smtn_ntby_tr_pbmn", "non_arbitrage_net_amount", "provider_amount_unit_unverified", CalculationMode.ACTUAL),
    ),
    "kis_investor_stock": (
